...
object AiLimbsHostPrimitiveCatalog {
    val all: List<HostPrimitiveDefinition> = listOf(
        ...
        HostPrimitiveDefinition(47, "host.interaction.cycle@1", "Interaction Cycle", "读取、设置、手动刷新或结束 AI Limbs 外部交互周期。", "周期计时、软过期、手动刷新、显式结束、系统接入提示与 receipt 边界均由 AI Limbs 基座执行。", HostPrimitiveMaturity.CONFIRMED, HostPrimitiveExposure.BOUND, false),
