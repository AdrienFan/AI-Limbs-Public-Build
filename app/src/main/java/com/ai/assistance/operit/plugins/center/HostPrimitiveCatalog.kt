...
object AiLimbsHostPrimitiveCatalog {
    val all: List<HostPrimitiveDefinition> = listOf(
        ...
        HostPrimitiveDefinition(50, "host.resident.runtime@1", "AI Limbs Resident Runtime", "管理 AI Limbs Resident 开关、Guardian 与独立核心验证入口；持续工作效果须经实机验证。", "开启请求 Resident 常驻与宿主 WakeLock，不代表系统已豁免冻结。core_probe/core_status/core_stop 仅供 Plugin Center 验证独立 Context 和 IPC，尚未迁移插件；不向插件暴露 Shell 或 Binder。", HostPrimitiveMaturity.CONFIRMED, HostPrimitiveExposure.BOUND, false),
