...
object CapabilityRegistry {
    ...
    val all: List<CapabilityDescriptor> = listOf(
        ...
        hostPrimitive("host.screen.session@1", CapabilityExecutionOwner.HOST),
        ...
        hostPrimitive("host.camera.capture@1", CapabilityExecutionOwner.HOST),
        hostPrimitive("host.camera.session@1", CapabilityExecutionOwner.HOST),
