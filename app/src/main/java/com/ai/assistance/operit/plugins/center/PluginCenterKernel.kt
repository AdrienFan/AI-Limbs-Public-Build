...
/**
 * AI Limbs Plugin Center v2 safe micro-kernel. Phase 1 enables only controlled declarative runtime.
 * Executable Android in-process plugins remain disabled until versioned Host Primitive contracts are wired.
 */
