...
include(":system-environment-center-core")
project(":system-environment-center-core").projectDir = file("plugin-lab/plugins/system-environment-center/runtime/terminal-core")
