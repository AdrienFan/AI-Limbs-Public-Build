    ...
    "tools": [
        ...
        },
        {
            ...
            "parameters": [
                ...
                {
                    "name": "download_dir",
                    "description": { "zh": "下载目录 (可选, 默认: /sdcard/Download/AiLimbs/plugins/jmcomic_downloader/downloads)", "en": "Download directory (optional; default: /sdcard/Download/AiLimbs/plugins/jmcomic_downloader/downloads)." },
                    "type": "string",
                    "required": false
                }
            ]
