...
菜单栏阶段：画室内容区顶部新增可横向滑动的十一项菜单标题（文件、编辑、视图、图像、图层、选择、滤镜、工具、设置、窗口、帮助）。点击仅切换选中样式，尚无下拉层级和命令；原有“⋮”菜单与弹出层已删除，顶部标题暂不触发命令。菜单栏由插件页面自己绘制，不增加基座接口，也不发布无实际操作的 AI 能力。
