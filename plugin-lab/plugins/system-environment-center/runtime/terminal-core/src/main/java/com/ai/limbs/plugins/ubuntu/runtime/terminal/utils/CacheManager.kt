...
class CacheManager(private val context: Context) {
    ...
    suspend fun unmountUbuntuMounts(
        terminalManager: com.ai.limbs.plugins.ubuntu.runtime.terminal.TerminalManager? = null
    ...
    suspend fun clearCache(terminalManager: com.ai.limbs.plugins.ubuntu.runtime.terminal.TerminalManager? = null) = withContext(Dispatchers.IO) {
