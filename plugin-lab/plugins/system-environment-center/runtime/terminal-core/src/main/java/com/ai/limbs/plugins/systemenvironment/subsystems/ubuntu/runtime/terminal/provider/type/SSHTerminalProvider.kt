...
import com.ai.limbs.plugins.systemenvironment.subsystems.ubuntu.runtime.terminal.data.SSHAuthType
...
import com.ai.limbs.plugins.systemenvironment.subsystems.ubuntu.runtime.terminal.utils.SSHFileConnectionManager
...
class SSHTerminalProvider(
    ...
    override suspend fun executeHiddenCommand(
        ...
        return sshFileManager.executeCommand(
            ...
            onOutputSnapshot?.invoke(result.output)
        }.getOrElse { error ->
