package com.ai.limbs.plugins.ubuntu.runtime.terminal.provider
...
class UbuntuDocumentsProvider : DocumentsProvider() {
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, "AI Limbs Ubuntu")
        row.add(DocumentsContract.Root.COLUMN_SUMMARY, "Access AI Limbs Ubuntu sandbox files")
