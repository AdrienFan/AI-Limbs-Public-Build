package com.ai.limbs.plugins.systemenvironment.subsystems.ubuntu.runtime.terminal.data
...
data class TerminalSessionData(
    ...
    val terminalSession: com.ai.limbs.plugins.systemenvironment.subsystems.ubuntu.runtime.terminal.TerminalSession? = null,
    val pty: com.ai.limbs.plugins.systemenvironment.subsystems.ubuntu.runtime.terminal.Pty? = null, // PTY 对象，用于获取终端模式
