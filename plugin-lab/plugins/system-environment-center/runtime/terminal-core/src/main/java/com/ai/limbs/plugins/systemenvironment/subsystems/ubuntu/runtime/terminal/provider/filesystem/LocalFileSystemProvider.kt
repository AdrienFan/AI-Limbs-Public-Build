package com.ai.limbs.plugins.systemenvironment.subsystems.ubuntu.runtime.terminal.provider.filesystem
...
class LocalFileSystemProvider(
    ...
    /**
     * Resolves a Linux path for plugin-owned operations that require a streaming java.io.File.
     * Base never sees this path; rootfs/mount knowledge remains inside the System Environment plugin.
     */
    fun resolveHostPathForPlugin(path: String): String = mapPath(path)
