...
internal object UbuntuToolCapabilities {
    ...
    private fun capabilities(terminal: TerminalManager): List<InProcessCapabilitySpec> = listOf(
        spec(
            ...
            name = "查询 Ubuntu 状态",
            description = "读取 Ubuntu 插件自持有 Runtime 的生命周期、空闲策略与当前使用者状态。",
            keywords = listOf("Ubuntu", "Linux", "状态", "生命周期", "runtime"),
            aliases = listOf("plugin.ubuntu.lifecycle.status", "plugin.system_environment.status"),
            effect = InProcessCapabilityEffect.READ_ONLY
        ) { status(terminal) },
        spec(
            id = "plugin.ubuntu.start",
            name = "启动 Ubuntu",
            description = "启动 Ubuntu 插件自持有的本地 Runtime。AI 调用不会触发前台开发环境提示。",
            keywords = listOf("Ubuntu", "Linux", "启动", "开机", "runtime"),
            aliases = listOf("plugin.ubuntu.lifecycle.start", "plugin.system_environment.start"),
        ...
        spec(
            ...
            aliases = listOf("plugin.ubuntu.lifecycle.stop", "plugin.system_environment.stop"),
            effect = InProcessCapabilityEffect.STATE_CHANGE
        ) { stop(terminal) },
        spec(
            id = "plugin.ubuntu.idle.get",
            aliases = listOf("plugin.system_environment.idle.get"),
            name = "查询 Ubuntu 空闲策略",
        ...
        spec(
            ...
            aliases = listOf("plugin.system_environment.idle.set"),
            name = "修改 Ubuntu 空闲策略",
        ...
        spec(
            ...
            aliases = listOf("plugin.system_environment.session.create"),
            name = "创建 Ubuntu 终端会话",
        ...
        spec(
            ...
            aliases = listOf("plugin.system_environment.session.execute"),
        ...
        spec(
            ...
            aliases = listOf("plugin.ubuntu.hidden.execute", "plugin.system_environment.command"),
            params = listOf(
                param("command", "string", "要执行的 shell 命令"),
        ...
        spec(
            ...
            aliases = listOf("plugin.system_environment.session.input"),
            name = "向 Ubuntu 会话输入",
        ...
        spec(
            ...
            aliases = listOf("plugin.system_environment.session.interrupt"),
            name = "中断 Ubuntu 会话",
        ...
        spec(
            ...
            aliases = listOf("plugin.system_environment.session.screen"),
            name = "读取 Ubuntu 会话屏幕",
        ...
        spec(
            ...
            aliases = listOf("plugin.system_environment.session.close"),
            name = "关闭 Ubuntu 终端会话",
    ...
    private fun renderScreen(
        screen: Array<Array<com.ai.limbs.plugins.ubuntu.runtime.terminal.view.domain.ansi.TerminalChar>>
    ): String {
