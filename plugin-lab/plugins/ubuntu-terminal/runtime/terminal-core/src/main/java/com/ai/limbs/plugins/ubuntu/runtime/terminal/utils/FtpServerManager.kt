...
class FtpServerManager private constructor(private val context: Context) {
    ...
    fun getFtpServerInfo(): String {
        return if (isFtpServerRunning()) {
            context.getString(
                com.ai.limbs.plugins.ubuntu.runtime.terminal.R.string.ftp_server_running_info,
                getLocalIpAddress(),
                FTP_PORT.toString(),
                FTP_USERNAME,
                FTP_PASSWORD
            ...
            context.getString(com.ai.limbs.plugins.ubuntu.runtime.terminal.R.string.ftp_server_not_running)
        }
    }
