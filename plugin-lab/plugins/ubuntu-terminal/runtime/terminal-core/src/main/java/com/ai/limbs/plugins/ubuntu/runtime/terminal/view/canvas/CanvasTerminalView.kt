package com.ai.limbs.plugins.ubuntu.runtime.terminal.view.canvas
...
import com.ai.limbs.plugins.ubuntu.runtime.terminal.R
import com.ai.limbs.plugins.ubuntu.runtime.terminal.SharedHiddenTerminalState
 import com.ai.limbs.plugins.ubuntu.runtime.terminal.view.domain.ansi.AnsiTerminalEmulator
 import com.ai.limbs.plugins.ubuntu.runtime.terminal.view.domain.ansi.TerminalChar
 import java.io.File
...
class CanvasTerminalView @JvmOverloads constructor(
    ...
    // PTY 引用（用于窗口大小同步）
    private var pty: com.ai.limbs.plugins.ubuntu.runtime.terminal.Pty? = null
     ...
     * 设置 PTY（用于窗口大小同步）
     */
    fun setPty(pty: com.ai.limbs.plugins.ubuntu.runtime.terminal.Pty?) {
        this.pty = pty
