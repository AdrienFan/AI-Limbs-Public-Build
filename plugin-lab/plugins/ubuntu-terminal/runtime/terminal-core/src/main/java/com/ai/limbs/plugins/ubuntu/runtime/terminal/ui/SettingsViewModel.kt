...
import com.ai.limbs.plugins.ubuntu.runtime.terminal.utils.FtpServerManager
import com.ai.limbs.plugins.ubuntu.runtime.terminal.TerminalManager
import com.ai.limbs.plugins.ubuntu.runtime.terminal.data.MirrorSource
...
import com.ai.limbs.plugins.ubuntu.runtime.terminal.data.SSHConfig
...
import com.ai.limbs.plugins.ubuntu.runtime.terminal.utils.VirtualKeyboardLayoutConfig
...
class SettingsViewModel(
    ...
    private fun updateChrootMountDisplay(result: CacheManager.MountInspectionResult) {
        ...
        _chrootMountStatus.value = app.getString(
            com.ai.limbs.plugins.ubuntu.runtime.terminal.R.string.chroot_mount_status_detected,
            result.count
        )
