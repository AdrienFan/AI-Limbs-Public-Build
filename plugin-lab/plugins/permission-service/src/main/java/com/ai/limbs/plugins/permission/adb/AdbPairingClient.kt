...
class AdbPairingClient(private val host: String, private val port: Int, private val pairCode: String, private val key: AdbKey) : Closeable {
    ...
    private fun setupTlsConnection() {
        ...
        val keyMaterial = org.lsposed.hiddenapibypass.HiddenApiBypass.invoke(
            Class.forName("com.android.org.conscrypt.Conscrypt"), null, "exportKeyingMaterial",
