...
data class LanerChatAttachmentInput(
    val filePath: String,
    val fileName: String,
    val mimeType: String,
    val fileSize: Long
...
internal object LanerChatTimestampAllocator {
    private var lastTimestamp: Long = 0L

    @Synchronized
    fun next(nowMs: Long = System.currentTimeMillis()): Long {
        val value = maxOf(nowMs, lastTimestamp + 1L)
        lastTimestamp = value
        return value
    }
}
